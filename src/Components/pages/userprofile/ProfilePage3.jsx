...
import { SecurityOnClick } from './ProfilePage3-OnClick.jsx';
export const ProfilePage3 = () => {
    const[Active, setActive] = useState(0);

  return (
    <div className='container-fluid'>
        <div className="profile-page3 pe-0 flex flex-col ">
            <div className="page3-heading">
                <h1>Security</h1>
                <h5>Change your security settings, set up secure authentication, or delete your account.</h5>
            </div>
            <div className='Password-con flex flex-row justify-between'>
            ...
            <div className='Two-Factor-authentication flex flex-row justify-between'>
                <div className='heading'><strong>Two-factor authentication</strong></div>
                <div><p>1. Download an authenticator app If you dont have an authenticator app installed, we recommend Google Authenticator or Microsoft Authenticator.</p></div>
                <div><button  className='Profile3-btn'>Reset</button></div>
            </div>
            <div className='Active-session flex flex-row justify-between'> 
            ...
            <div className='Delete-account flex flex-row justify-between'>
